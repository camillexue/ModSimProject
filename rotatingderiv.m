...
gravity = 9.8; %m/s^2
angle = 30 * pi / 180; %assuming angle, convert to radians
r = .21; %assuming cm is a third of the way in from handle
...
if t <= .1
    F_d_x = 0;
    F_d_y = 0;
    F_a = 25; %force applied, assumed based on data
else 
...
I = (1 / 12) * mass * length^2; %moment of inertia of rod about center of mass
...
res = [dxdt; dydt; dVxdt; dVydt; dWdt];
